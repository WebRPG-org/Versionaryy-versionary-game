/*:
* @plugindesc v.11.2.6 [MV] Advanced project testing and various functions. Made with ♥ by DKPlugins.
* @author DKPlugins
* @help
...
/*:ru
* @plugindesc v.11.2.6 [MV] Расширенное тестирование проекта и различные функции. Сделано с ♥ от DKPlugins.
* @author DKPlugins
* @help
...
window.Imported.DKTools = '11.2.6';
